...
def index():
    ...
    random_tutorials = [list(all_bucket_objects)[random.randint(0, len(list(all_bucket_objects))-1)].key.replace(".json", "").title(), 
                        list(all_bucket_objects)[random.randint(0, len(list(all_bucket_objects))-1)].key.replace(".json", "").title(), 
                        list(all_bucket_objects)[random.randint(0, len(list(all_bucket_objects))-1)].key.replace(".json", "").title()]
